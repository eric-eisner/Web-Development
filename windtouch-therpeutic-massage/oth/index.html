...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=480,height=420');");
}
</script>
	...
	<tr>
		...
		<td width="788" valign="top">
			<table width="788" align="center">
				<tr>
					<td colspan="2"><div align="center"><font face="tahoma" class="int"><b>Welcome to the Homepage for Wind Touch Therapeutic Massage</b></font></div></td>
				</tr>
				<tr>
					<td height="9"></td>
				</tr>
				<tr>
					<td width="394"><font face="tahoma">Our location:</font></td>
					<td width="394" align="left" rowspan="7"><font face="tahoma">Click <a href="javascript:popUp('map.php')">HERE</a> for a road map</font><br><br><img src="/images/office.jpg" alt="The massage room"></td>
				</tr>
				<tr>
					<td height="2"></td>
				</tr>
				<tr>
					<td><font face="tahoma">&nbsp;&nbsp;&nbsp;&nbsp;Lincolnshire Office Building<br>&nbsp;&nbsp;&nbsp;&nbsp;13965 W. Burleigh Rd., Suite 202<br>&nbsp;&nbsp;&nbsp;&nbsp;Brookfield, WI 53005</font></td>
				</tr>
				<tr>
					<td height="9"></td>
				</tr>
				<tr>
					<td><font face="tahoma">Our new office hours: (effective 4/4/05)*</font></td>
				</tr>
				<tr>
					<td height="2"></td>
				</tr>
				<tr>
					<td><font face="tahoma">&nbsp;&nbsp;&nbsp;&nbsp;Monday..............Closed<br>&nbsp;&nbsp;&nbsp;&nbsp;Tuesday.............8:30am - 5:00pm<br>&nbsp;&nbsp;&nbsp;&nbsp;Wednesday.........8:30am - 2:30pm<br>&nbsp;&nbsp;&nbsp;&nbsp;Thursday............Closed<br>&nbsp;&nbsp;&nbsp;&nbsp;Friday.................Closed<br>&nbsp;&nbsp;&nbsp;&nbsp;Saturday.............9:30am - 2:30pm<br>&nbsp;&nbsp;&nbsp;&nbsp;Sunday...............Closed</font></td>
				</tr>
				<tr>
					<td height="9"></td>
				</tr>
				<tr>
					<td colspan="2"><font face="tahoma"><b>*Cassandra will be completing her Masters of Science in Oriental Medicine on 7/1/05.<br><br>She will start offering Acupuncture & Herbs as of July -- watch for updates</b></font></td>
				</tr>
				<tr>
					<td height="9"></td>
				</tr>
				<tr>
					<td width="394" align="center" rowspan="3"><img src="/images/cass.jpg" alt="Cassandra Wind - Professional Massage Therapist"></td>
					<td width="394"><font face="tahoma">About Cassandra Wind:</font></td>
				</tr>
				<tr>
					<td height="2"></td>
				</tr>
				<tr>
					<td><font face="tahoma"><ul><li>Mother of Three Children<li>Registered with State of Wisconsin<li>Teaching Assistant for the Upledger Institute<li>Craniosacral Therapist for Adults and Pediatrics<li>Certified Infant Massage Instructor<li>Internship in China to study Tui Na Massage & Acupuncture<li>Enrolled in Master of Science - Oriental Medicine<li>Bachelor of Science - Health Arts<li>Nuclear Medicine Technologist</ul></font></td>
				</tr>
				<tr>
					<td height="18"></td>
				</tr>
				<tr>
					<td width="394"><font face="tahoma">Massage and Bodywork Rates:</font></td>
					<td width="394" align="center"><font face="tahoma">We accept the following credit cards:</font></td>
				</tr>
				<tr>
					<td height="2"></td>
				</tr>
				<tr>
					<td width="394"><font face="tahoma"><p>&nbsp;&nbsp;15 minute (localized treatment)....$25<br>&nbsp;&nbsp;30 minute..................................$45<br>&nbsp;&nbsp;55 minute..................................$75<br>&nbsp;&nbsp;90 minute..................................$110</p></font></td>
					<td width="394" align="center"><img src="/images/cards.gif" alt="Visa, Mastercard, Discover/Novus, American Express" border="0"></td>
				</tr>
				<tr>
					<td height="2"></td>
				</tr>
				<tr>
					<td colspan="2"><font face="tahoma"><div align="center"><i>*Gift Certificates also available (see products page for prices)</i></div></font></td>
				<tr>
					<td height="50"></td>
				</tr>						
			</table>
