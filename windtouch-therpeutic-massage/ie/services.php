	...
	<tr>
		...
		<td width="788" valign="top">
			<table width="788" align="center">
				<tr>
					<td align="center"><font face="tahoma" class="int"><b>Services Offered</b></font></td>
        </tr>
				<tr>
					<td height="15"></td>
        </tr>
				<tr>
					<td><font face="tahoma">
            <p><b>Relaxation Massage</b> - Incorporates Swedish and conventional massage techniques to increase circulation, decrease stress, and relax the total body.  Essential oils are used to bring healthy nutrients to the skin and underlying tissues.  At your option, soft, meditative music can be played to help you relax and facilitate stress relief.</p></td>
        </tr>
				<tr>
					<td height="15"></td>
        </tr>
				<tr>
					<td><font face="tahoma">
            <p><b>Craniosacral Therapy</b> - Is a light touch manual therapy that addresses restrictions in the Craniosacral system - the membranes and fluid that surround and protect the brain and spinal cord.  This vital system extends from the bones of the skull, face and mouth, which make up the cranium, down to the sacrum, or tailbone. Since the Craniosacral system directly impacts the central nervous system, it's easy to see how an imbalance there could cause any number of sensory, motor or neurological disabilities.  Craniosacral Therapy helps correct those restrictions so the body can release the effects of stress - naturally. Research strongly suggests that the birth process is responsible for many brain dysfunctions and central nervous system problems.  Craniosacral Therapy carried out in the delivery room or within the first few days of life could potentially reduce a wide variety of difficulties, many of which might not become apparent until your child is in school.  Even problems with head shape and skull-bone override can be corrected with the use of Craniosacral Therapy. Clients have found this therapy useful for migraines and headaches, after trauma both physical and emotional, during pregnancy, fatigue, depression, anxiety and when they just can't seem to relax.  Stroke patients who start receiving this treatment within six weeks after the stroke seem to enhance the recovery process.  This therapy is useful to athletes who are not achieving the performance they want by helping their bodies recover through a deeper relaxation than can be achieved with massage.</p></td>
        </tr>
				<tr>
					<td height="15"></td>
        </tr>
				<tr>
					<td><font face="tahoma">
            <p><b>Neuromuscular Therapy</b> - Helps restore the structural, functional and postural integrity of the body.  Neuromuscular therapy removes restrictions, normalizes dysfunction, reduces pain, energy loss, improves posture and biomechanics.  Cassandra accomplishes these tasks by evaluating and addressing the body's soft-tissue components.  She responds to specific conditions such as ischemia(the lack of blood flow due to hyper constricted tissues), nerve compression or entrapment, neurological trigger point sensation and postural distortion using several treatment modalities.</p></td>
        </tr>
				<tr>
					<td height="15"></td>
        </tr>
				<tr>
					<td><font face="tahoma">
            <p><b>Ayurvedic Lymphatic Massage</b> - Is a light touch massage that stimulates fluid circulation through the lymph glands, organs, nodes, and vascular system, thus purifying the body of unwanted toxins.  Pure essential oils are used for this treatment.  This therapy is deeply relaxing and powerfully effective in flushing waste from the body and stimulating its natural immune strength.  Cassandra recommends this treatment during each change of season to boost your body's immune system and reduce your susceptibility to illness.</p></td>
        </tr>
				<tr>
					<td height="15"></td>
        </tr>
				<tr>
					<td><font face="tahoma">
            <p><b>Tui Na Massage</b> - Is one of the four main branches of Traditional Chinese Medicine.  It differs from other forms of massage in that it is used to treat specific illnesses of an internal nature as well as musculoskeletal ailments. The treatment involves the use of a wide range of specific manual techniques, all of which have particular effects and areas of influence.  Some of the manual techniques include pressure points, cupping and guasha.</p></td>
        </tr>
				<tr>
					<td height="15"></td>
        </tr>
				<tr>
					<td><font face="tahoma">
            <p><b>Infant Massage</b> - Is a system of touching and stroking your baby in a way that expresses love, support and protection.  It is a unique and specific way to create and strengthen a special closeness and awareness between parents and baby. This highly effective therapy has been shown to improve infant sleeping patterns, diminish anxious behavior, reduces stress, improve mental and motor skill development and visual attentiveness.  This therapy promotes your baby's health and well-being, establishes you as an important member of the team of caregivers, and makes you and your baby feel wonderful.</p></td>
        </tr>
				<tr>
					<td height="50"></td>
        </tr>        							
